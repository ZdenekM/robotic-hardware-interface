...
// motors.c -> funkce pro obsluhu motorů
...
// volá se z main
// dekóduje přijaté info z modulu MotorControl
void decodeMotorInfo(tmotor *mf, tmotor *mr) {

		// údaje pro přední motor ----------------------------------
...
// načte z modulu info o motorech a vyplní ho do struktur tmotor
...
// nastavení požadované rychlosti motorů
